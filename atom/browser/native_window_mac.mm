...
NativeWindowMac::NativeWindowMac(const mate::Dictionary& options,
    ...
    : NativeWindow(options, parent),
      ...
      window_controls_visibility_(true),
      was_window_controls_visibility_specified_(false),
...
void NativeWindowMac::SetSimpleFullScreen(bool simple_fullscreen) {
  ...
  if (simple_fullscreen && !is_simple_fullscreen_) {
    ...
    if ( !fullscreen_window_title() ) {
      ...
      // Lets keep previous behaviour - hide window controls in titled fullscreen mode when
      // not sepcified otherwise.
    ...
    [[window standardWindowButton:NSWindowZoomButton] setHidden:!window_controls_visibility_];
    [[window standardWindowButton:NSWindowMiniaturizeButton] setHidden:!window_controls_visibility_];
    [[window standardWindowButton:NSWindowCloseButton] setHidden:!window_controls_visibility_];
...
bool NativeWindowMac::IsWindowControlsVisible() {
  return !([[window_ standardWindowButton:NSWindowCloseButton] isHidden] &&
